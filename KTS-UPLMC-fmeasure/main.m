...
%     end
    ...
    %% SVM
    fprintf(['SVM AVG=%3.2f,Accuracy=%3.2f,AUC=%3.2f,Sensitivity=%3.2f,Specificity=%3.2f,Fmeasure=%3.2f,Gmeans=%3.2f,' ...
        'time = %3.2f,C = %3.2f,p1=%3.2f'], (AUC0+Fmeasure0+Gmeans0)/3,acc_svm, AUC0,Sensitivity0,Specificity0,Fmeasure0,Gmeans0,time0,opt_C0,p1);
    
    %% UPSVM
    fprintf(['\n UPSVM AVG=%3.2f,Accuracy=%3.2f,AUC=%3.2f,Sensitivity=%3.2f,Specificity=%3.2f,Fmeasure=%3.2f,Gmeans=%3.2f,' ...
        'time = %3.2f,tau = %3.2f,C = %3.2f,p1=%3.2f'],(AUC1+Fmeasure1+Gmeans1)/3,acc_upsvm,AUC1,Sensitivity1,Specificity1,Fmeasure1,Gmeans1,time1,opt_tau1,opt_C1,p1);
    
    %% PSVM
    fprintf(['\n PSVM AVG=%3.2f,Accuracy=%3.2f,,AUC=%3.2f,Sensitivity=%3.2f,Specificity=%3.2f,Fmeasure=%3.2f,Gmeans=%3.2f,' ...
        'time = %3.2f,tau = %3.2f,C = %3.2f,p1=%3.2f'],(AUC2+Fmeasure2+Gmeans2)/3,acc_psvm,AUC2,Sensitivity2,Specificity2,Fmeasure2,Gmeans2,time2,opt_tau2,opt_C2,p1);
